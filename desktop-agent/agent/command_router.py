...
_REGISTRY: dict[str, dict] = {
    ...
    "open_explorer":     {"fn": lambda c: AppLauncher.open_file_manager(c.get("path", ""))},
    ...
    "get_running_processes": {"fn": lambda c: AppLauncher.get_running_processes(c.get("limit", 50))},
    "get_system_info":       {"fn": lambda c: AppLauncher.get_system_info()},
    "shutdown_system":       {"fn": lambda c: AppLauncher.shutdown_system()},
    ...
    # ── Mouse ──
    "mouse_move":             {"fn": lambda c: MouseController.move(int(float(c["x"])), int(float(c["y"])), float(c.get("duration", 0.0))),             "required": ["x", "y"]},
    "mouse_move_relative":    {"fn": lambda c: MouseController.move_relative(int(float(c["dx"])), int(float(c["dy"])), float(c.get("duration", 0.0))), "required": ["dx", "dy"]},
    "mouse_move_smooth":      {"fn": lambda c: MouseController.move_smooth(int(float(c["x"])), int(float(c["y"])), int(c.get("steps", 20))),         "required": ["x", "y"]},
    "mouse_click":            {"fn": lambda c: MouseController.click(int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None, c.get("button", "left"))},
    "mouse_right_click":      {"fn": lambda c: MouseController.right_click(int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None)},
    "mouse_middle_click":     {"fn": lambda c: MouseController.middle_click(int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None)},
    "mouse_double_click":     {"fn": lambda c: MouseController.double_click(int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None)},
    "mouse_triple_click":     {"fn": lambda c: MouseController.triple_click(int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None)},
    "mouse_drag":             {"fn": lambda c: MouseController.drag(int(float(c["x1"])), int(float(c["y1"])), int(float(c["x2"])), int(float(c["y2"])), float(c.get("duration", 0.4)), c.get("button", "left")), "required": ["x1", "y1", "x2", "y2"]},
    "mouse_drag_relative":    {"fn": lambda c: MouseController.drag_relative(int(float(c["dx"])), int(float(c["dy"])), float(c.get("duration", 0.4))), "required": ["dx", "dy"]},
    "mouse_scroll":           {"fn": lambda c: MouseController.scroll(int(float(c["amount"])), int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None), "required": ["amount"]},
    "mouse_scroll_horizontal":{"fn": lambda c: MouseController.scroll_horizontal(int(float(c["amount"]))),                          "required": ["amount"]},
    "mouse_down":             {"fn": lambda c: MouseController.mouse_down(c.get("button", "left"), int(float(c["x"])) if c.get("x") is not None else None, int(float(c["y"])) if c.get("y") is not None else None)},
    ...
    "get_pixel_color":        {"fn": lambda c: MouseController.pixel_color(int(float(c["x"])), int(float(c["y"]))),                             "required": ["x", "y"]},
    ...
    "press_escape":     {"fn": lambda c: KeyboardController.press_key("escape")},
    "press_esc":        {"fn": lambda c: KeyboardController.press_key("escape")},
    "press_tab":        {"fn": lambda c: KeyboardController.press_key("tab")},
    "press_backspace":  {"fn": lambda c: KeyboardController.press_key("backspace")},
    "press_delete":     {"fn": lambda c: KeyboardController.press_key("delete")},
    "press_space":      {"fn": lambda c: KeyboardController.press_key("space")},
    ...
    "take_screenshot":  {"fn": lambda c: KeyboardController.take_screenshot()},
